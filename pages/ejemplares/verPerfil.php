        ...
        <!-- <div class="card-header">
          <div class="row mx-auto">
            <div style="vertical-align: middle; margin: 20px">               
                     <p class="font-weight-light"> <h3>Catalogo del  ejemplar </h3>  Administrar informacion del ejemplar.</p>   
            </div>           
          </div>     
        </div> -->
        <!--Cuerpo del panel--> 
        <div class="card-body">              
          <div class="row">            
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  <button type="button" class="btn btn-light float-left"  data-toggle="modal" data-target="#newEstanteModal"  >
                          <img data-toggle="tooltip" data-placement="top"  title="Volver" src="img/icons/atras.png" width="45" height="45">
                        </button>
                  <div class="row">
                 <!--    <div class="col-sm-5">
                    ...
                    <div class="col-sm-2">
                      <div class="btn-group float-right" role="group" aria-label="Opciones"> 
                        <button class="btn btn-light float-right" type="button" onclick="recargarTablaLimpiar();" data-toggle="tooltip" data-placement="top" title="Reservar">
                          <img src="img/icons/BookstandReload.png" width="45" height="45">
                        </button>
                        <button class="btn btn-light float-right" type="button" onclick="recargarTablaLimpiar();" data-toggle="tooltip" data-placement="top" title="Editar">
                          <img src="img/icons/BookstandReload.png" width="45" height="45">
                        </button>

                        <button type="button" class="btn btn-light float-right"  data-toggle="modal" data-target="#newEstanteModal"  >
                          <img data-toggle="tooltip" data-placement="top"  title="Eliminar" src="img/icons/Bookstand+.png" width="45" height="45">
                        </button>
                        
                      </div>
                    </div>
                    </div>
                     </div>  <div align="center" name="cargarTablaPerfil" id="cargarTablaPerfil"> </div>
...
function recargarTabla(){
  ...
  $("#cargarTabla").load("pages/Estantes/tablaEstantes.php?pagina=1&busqueda="+ busqueda);
   $("#cargarTablaPerfil").load("pages/ejemplares/tablaPerfil.php");
  setTimeout( function() {
