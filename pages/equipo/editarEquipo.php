<?php 
	...
	$editequiponom=$_POST['editequiponom'];
	$editequicodifi=$_POST['editequicodifi'];	
	$editequipodes=$_POST['editequipodes'];	
    $editequicod=$_POST['editequicod'];
	$usuCodigo=$_SESSION['usuCodigo'];
    $bitPersonaName=$_SESSION['nombreComp'];

$checkValidation="SELECT * FROM $tablaEquipo WHERE $varequicodifi='$editequicodifi'  AND $varequitip='$editequiponom';";
