          ...
          <div class="row">
            ...
            <div class="col-sm-10">
              ...
              <div class="form-group">               
                ...
                <input type="text" class="form-control" name="formequicodifi" id="formequicodifi" aria-describedby="formequicodifi" placeholder="" >
                <label for="TituloLabel">NOMBRE EQUIPO</label>
                <input type="text" class="form-control" name="formequiponom" id="formequiponom" aria-describedby="formequiponom" placeholder="">
                <label for="TituloLabel">DESCRIPCION DEL EQUIPO</label>
                <input type="text" class="form-control" name="formequipodes" id="formequipodes" aria-describedby="formequipodes" placeholder="" >
              </div>
        ...
        <form id="formEditequipo" name="formEditequipo">
          <div class="row">
            ...
            <div class="col-sm-10">
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="editequicod" id="editequicod" aria-describedby="editequicod" placeholder="" hidden="">
                <label for="TituloLabel">CODIGO</label>                 
                <input type="text" class="form-control" name="editequicodifi" id="editequicodifi" aria-describedby="editequicodifi" placeholder="" >
                <label for="TituloLabel">NOMBRE EQUIPO</label>
                <input type="text" class="form-control" name="editequiponom" id="editequiponom" aria-describedby="editequiponom" placeholder="">
                <label for="TituloLabel">DESCRIPCION DEL EQUIPO</label>
                <input type="text" class="form-control" name="editequipodes" id="editequipodes" aria-describedby="editequipodes" placeholder="" >
              </div>
          ...
          <div class="row">         
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="delequipocod" id="delequipocod" aria-describedby="delequipocod" placeholder="equipo" hidden="true">
                <input type="text" class="form-control" name="delequiponom" id="delequiponom" aria-describedby="delequiponom" placeholder="equipo" hidden="true">
          ...
          <div class="row">         
            <div class="col-sm-12 ">
              <div class="form-group ">
                ...
                <input type="text" class="form-control" name="modalequicodimg" id="modalequicodimg" aria-describedby="modalequicodimg" placeholder="Codigo Libro" hidden="true">
                 <input type="text" class="form-control" name="modalequitipimg" id="modalequitipimg" aria-describedby="modalequitipimg" placeholder="Codigo Libro" hidden="true">
...
function editarequipo(){
  ...
  if ($("#editequicodifi").val()==""){
    ...
    $("#respuestaEditarequipo").html("Campo de Nombre del equipo esta Vacio");
  }else if ($("#editequipopais").val()==""){
    $("#respuestaEditarequipo").show();
    $("#respuestaEditarequipo").html("Campo de Pais del equipoe esta Vacio");
  }
  else {
  ...
  if ($("#delequipocod").val()==""){
    ...
    $.ajax({
      ...
      success: function (data){
        recargarTabla()
        if (data=="0"){
          // ERROR, equipo TIENE LIBROS INSCRITOS
          var url = "pages/equipo/requisitosBorrarCat.php";
           $.ajax({
              ...
              success: function (data){
                  ...
                  $("#labelBorrar").html("No se puede borrar a este equipo. pues esta siendo usado por los libros:");
